# Installing TextFlowThon: PyPI vs. Source

TextFlowThon can be installed in two main ways, depending on your needs:

---

## 1. For Most Users (PyPI)

If you just want to use TextFlowThon in your own project, install it from PyPI:
...
PyPI packages only include the library code, not the example scripts or full documentation. To access the examples, clone the [GitHub repository](https://github.com/yourusername/textflowthon).
